...
const SideBar = ({ setOutgoingSideBarStatus}) => {
    ...
    <div>
         <div className={classes.sideBar}>
            ...
            setOutgoingSideBarStatus(true);}} >Поиск города</button>
                <div className={classes.switchBox}>
                    <button onClick={changeThemeDark} className={`${classes.switchOff} ${isActive? classes.none:''}`}><img src={switch_off} alt="switch off"/></button>
                    <button onClick={changeThemeLight} className={`${classes.switchOn} ${isActive? '':classes.none}`}><img  src={switch_on} alt="switch on"/></button>
                </div>
                </div>
                <div className={classes.content}>
                        <div className={classes.imgBox}>
                            <img src={snowflake} className={classes.snowflake} alt="snowflake"/>
                        </div>
                ...
                <div className={classes.bottom}>
                    ...
                    <div className={classes.cityBox}>
                        ...
                        <p className={classes.city}>{value.citySearch}</p>
                    </div>
                </div>
        </div> 
    </div>
