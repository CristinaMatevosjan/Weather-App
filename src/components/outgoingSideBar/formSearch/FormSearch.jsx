...
const FormSearch = () => {
    ...
    return (
        <form className={classes.searchField} onSubmit={value.handleSubmit}>
            <input className={classes.searchInput} type="search" value={value.city}
                onChange={value.handleCityChange}/>
