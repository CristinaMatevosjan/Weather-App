        ...
        <section className={classes.forecast}>
            <div className={classes.forecast__heading}>
                ...
                <div className={classes.forecast__box}>
                    <NavLink  to='/week' className={`${classes.labelWeek} ${classes.label}`} > на неделю</NavLink>
                    <NavLink  to='/hourly'  className={classes.label} > почасовой</NavLink>
                </div>
            </div>
